...
# VGG16 modelini yükle ve son katmanı güncelle (7 sınıf için)
...
model.load_state_dict(torch.load("C:/Users/dteme/OneDrive/Masaüstü/bionluk/skin cancer/vgg16/best_model_vgg.pth", map_location=device))
model.eval()
...
def predict_image_with_scores(image_path):
    ...
    transform_test = transforms.Compose([
        transforms.Resize((224, 224)),  # VGG için beklenen giriş boyutu
        transforms.ToTensor(),
...
image_path = "C:/Users/dteme/OneDrive/Masaüstü/bionluk/skin cancer/balanced_dataset/train/bcc/bcc_synthetic_2.png"
print("Tahmin edilen sınıf:", predict_image_with_scores(image_path))

# Validation veri setini yüklemek için ön işleme
val_data_dir = "C:/Users/dteme/OneDrive/Masaüstü/bionluk/skin cancer/balanced_dataset/val"  # Validation veri seti dizininizi girin
val_transform = transforms.Compose([
    transforms.Resize((224, 224)),  # VGG'nın giriş boyutu
    transforms.ToTensor(),
    transforms.Normalize([0.485, 0.456, 0.406], [0.229, 0.224, 0.225])
])
